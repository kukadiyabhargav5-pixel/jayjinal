    ...
    <section className={styles.countSec}>
      ...
      <div className={styles.countGrid}>
        {[{ v: t.d, l: "Days" }, { v: t.h, l: "Hours" }, { v: t.m, l: "Minutes" }, { v: t.s, l: "Seconds" }].map((item, i) => (
          <motion.div key={item.l} className={styles.countWrap} initial={{ opacity: 0, scale: 0.5, y: 40 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.12, type: "spring", stiffness: 120 }}>
